...
charset=UTF-8"/>
   ...
   <link href="https://fonts.googleapis.com/css?family=Montserrat:900" rel="stylesheet"/>
    ...
    <script src="JS/Start.js" type="text/css"></script>
        ...
        if($result->num_rows > 0){
            ...
            while ($row = $result->fetch_assoc()){
                ...
                <td class="wrapper_button">';
                 if ($row['id'] != 1) {
                     echo '<img src="img/x.png" class="guzik_usun" onclick="usun_uzytkownika('.$row['id'].')"/>';
                 } else {
                     echo 'SuperUser';
                 }
                 echo '</td>
            ...
            echo '<div class="f_form" style="width:20%; margin-top:50px;">
                <form>
                    ...
                    <input type="checkbox" name="admin" value="TAK"> Administrator <br>
                    <input id="przycisk_f" class="button" type="submit" value="Dodaj użytkownika" onclick="addUser();"/>
                </form>
                <p id="komunikat"></p>
                </div>';
